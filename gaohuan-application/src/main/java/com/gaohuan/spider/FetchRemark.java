...
public class FetchRemark {
    ...
    public static void doFetch1() throws IOException {
        int hotelId = 90893715;
        int pageIndex = 1;
//        String url = "http://hotel.elong.com/ajax/detail/gethotelreviews?hotelId=90893715&recommendedType=1&pageIndex=1&mainTagId=0&subTagId=0&_=1470719487692";
        while (true) {
    ...
    public static void doFetch2() throws IOException {
        int page = 1;
        while (true) {
